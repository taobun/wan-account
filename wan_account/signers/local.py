...
from wan_account.signers.base import (
    BaseAccount,
)
...
class LocalAccount(BaseAccount):
    ...
    def __init__(self, key, account):
        ...
        :param ~wan_account.account.Account account: the key-unaware management API
        """
    ...
    def privateKey(self):
        """
        .. CAUTION:: Deprecated for :meth:`~wan_account.signers.local.LocalAccount.key`.
    ...
    def encrypt(self, password, kdf=None, iterations=None):
        ...
        :meth:`~wan_account.account.Account.encrypt`, but without a private key argument.
        """
    ...
    def sign_message(self, signable_message):
        """
        Generate a string with the encrypted key, as in
        :meth:`~wan_account.account.Account.sign_message`, but without a private key argument.
        """
